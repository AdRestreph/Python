...
from Proyectos.ReconocerIA.Image_preprocessing import resize_img, matrix_gray
from Proyectos.ReconocerIA.data_augmentation import gaussian_noise, moved_img, degrees_img
